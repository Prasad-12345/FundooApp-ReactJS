        ...
        <List>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary={'Remainders'} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary={'Edit label'} sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem  disablePadding sx={{ display: 'block' }} >
              <ListItemButton
                ...
                onClick={()=>listenToSideNav('delete')}
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
